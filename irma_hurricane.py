...
#querries to search
sets_of_keywords=[
        ['Florida', '#hurricane','#irma','irma','help'],
        ['#IrmaHurricane','need help'],
        ['Florida','irma' ,'help' ],
        ['Florida','help' ,'flood' ],     
        ['Florida','help' ,'Storm' ], 
        ['#hurricane','Florida' ,'Storm','help'  ],   
        ['hurricane','Florida' ,'help' ],         
        ]

hold_unique_urls=defaultdict(lambda:list) # holds url and lambda        

printed_data_all=open("tweets_for_hurricane_florida_mini.csv","w",1)
...
try:
    ...
    for set_of_keys in sets_of_keywords:
        ...
        ts = TwitterSearch(
            consumer_key = 'QowXZfKzmq6Jj8Kkgdy78YCvI',
            consumer_secret = 'f2d9OJ9eDdIY8tkPSrBntJxcxHrE1JxloYQAhCBDgs9531D1TK',
            access_token = '903171270094749697-iln5cQj6bCqIYAoXdmMeBvgkDvoyX3n',
            access_token_secret = 'EBmuKJ6PzNdRjpFiI57tnb6jtJDLj1t2Mk8XBRELzWuAu'
         )
        ...
        for tweet in ts.search_tweets_iterable(tso):
            ...
            try:
                ...
                #print( 'url %s  tweeted: %s time %s' % ( url ,tweet_txt ,date) )
    ...
    printed_data=open("tweets_for_hurricaneflorida.csv","w",1)
